      ...
      var r = n(2),
        o = {
          ...
          build: function (e) {
            ...
            return t.test(r)
              ? '<img alt="' + e + '" referrerPolicy="no-referrer" class="vemoji" src="' + r + '" />'
              : ''
          },
        }
      t.default = o
        ...
        (o.prototype.bind = function () {
          ...
          ;(e.$emoji = {
            ...
            (e.$preview = {
              show: function () {
                return (
                  j ? (e.$emoji.hide(), o.addClass('actived'), n.html(j).show(), M()) : e.$preview.hide(),
                  e.$preview
                )
              },
              hide: function () {
          ...
          var d = function (t) {
            ...
            r || e.$preview.hide(),
              j != r &&
                ((j = r), o.hasClass('actived') > -1 && j != n.html() && n.html(j), (0, c.default)(t[0]), M())
          }
            ...
            return (
              ...
              (t = t || ''),
              {
                replace: function (t, n) {
                  return (
                    (n = n.source || n), (n = n.replace(/(^|[^\[])\^/g, '$1')), (e = e.replace(t, n)), this
                  )
                },
                getRegex: function () {
                ...
                if (
                  ...
                  (e = e.substring(o[0].length)),
                    this.tokens.push({
                      ...
                      pre:
                        !this.options.sanitizer && ('pre' === o[1] || 'script' === o[1] || 'style' === o[1]),
                      text: o[0],
                    })
    ...
    function (e, t, n) {
      ...
      ;(c.prototype.locale = function (e) {
        ...
        (c.prototype.t = function (e, t) {
          ...
          return (
            'string' == typeof n && (r = l(n, o, this.currentLocale, this.tokenRegex, this.pluralRules)), r
          )
        }),
