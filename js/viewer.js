...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).Viewer = e())
})(this, function () {
  'use strict'
  function e(e, t) {
    var i,
  ...
  function xt(t, e, i, n) {
    ...
    return (
      nt(Event) && nt(CustomEvent)
        ? (o = new CustomEvent(e, l({ bubbles: !0, cancelable: !0, detail: i }, n)))
  ...
  var It,
    At = {
        ...
        ;(l.innerHTML = ''),
          ot(this.images, function (i, t) {
            var e,
              ...
              s =
                i.alt ||
                (_((e = o)) ? decodeURIComponent(e.replace(/^.*\//, '').replace(/[?&#].*$/, '')) : ''),
              a = r.getImageURL(i)
            ;(o || a) &&
      ...
      renderList: function () {
        ...
        rt(
          this.list,
          st({ width: e * this.length - n }, kt({ translateX: (this.viewerData.width - i) / 2 - e * t }))
        )
      },
      resetList: function () {
        var t = this.list
        ...
        ;(this.imageInitializing = {
          ...
          (t = Dt(e, l, function (t, e) {
            ...
            l.rotatable && ((t.rotate = d.rotate || 0), (e.rotate = 0)),
              l.scalable &&
                ((t.scaleX = d.scaleX || 1), (t.scaleY = d.scaleY || 1), (e.scaleX = 1), (e.scaleY = 1)),
              (h.imageData = t),
    ...
    r = {
      bind: function () {
        ...
        yt(e, O, (this.onClick = this.click.bind(this))),
          ...
          t.zoomable &&
            t.zoomOnWheel &&
            yt(e, W, (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
      ...
      unbind: function () {
        ...
        wt(e, O, this.onClick),
          ...
          wt(i, Y, this.onPointerDown),
          wt(n, X, this.onPointerMove),
          wt(n, M, this.onPointerUp),
          wt(n, F, this.onKeyDown),
          wt(window, q, this.onResize),
          t.zoomable && t.zoomOnWheel && wt(e, W, this.onWheel, { passive: !1, capture: !0 }),
    ...
    t = {
      click: function (t) {
        ...
        switch (
          (o ||
            ...
            (o = gt((n = n.parentElement), K)),
          a && t.isTrusted && n === this.canvas && clearTimeout(this.clickCanvasTimeout),
          o)
        ) {
          case 'mix':
      ...
      dblclick: function (t) {
        t.preventDefault(),
          this.viewed &&
            t.target === this.image &&
            (a && t.isTrusted && clearTimeout(this.doubleClickImageTimeout), this.toggle(t))
      },
      load: function () {
        var t = this
          ...
          this.initImage(function () {
            ut(n, E, i.movable),
              ...
              t.renderImage(function () {
                ;(t.viewed = !0),
                  (t.viewing = !1),
                  nt(i.viewed) && yt(e, V, i.viewed, { once: !0 }),
                  xt(e, V, { originalImage: t.images[o], index: o, image: n }, { cancelable: !1 })
              })
          })
      },
      loadImage: function (t) {
        ...
        Dt(n, this.options, function (t, e) {
          var i = t / e,
            t = o,
            e = s
          o < s * i ? (a ? (t = s * i) : (e = o / i)) : a ? (e = o / i) : (t = s * i),
            rt(n, st({ width: t, height: e }, kt({ translateX: (o - t) / 2, translateY: (s - e) / 2 })))
        })
      },
      keydown: function (t) {
        var e = this.options
    ...
    St = {
      ...
      view: function () {
        ...
        if (
          ...
          !1 === xt(e, 'view', { originalImage: this.images[t], index: t, image: c }) ||
            !this.isShown ||
            this.hiding ||
            this.played)
        )
        ...
        h && (ct(h, m), h.removeAttribute('aria-selected')),
          lt(a, m),
        ...
        function u() {
          ...
          o.innerHTML = _(
            (t = nt(e)
              ? e.call(i, c, t)
              : ''.concat(l, ' (').concat(t.naturalWidth, ' × ').concat(t.naturalHeight, ')'))
          )
            ? t
            ...
            abort: function () {
              wt(e, V, u),
                c.complete
                  ...
                  : ((c.src = ''), wt(c, N, d), i.timeout && clearTimeout(i.timeout))
            },
          }),
          c.complete
            ? this.load()
      ...
      prev: function () {
        ...
        return (
          t < 0 &&
            (t = 0 < arguments.length && void 0 !== arguments[0] && arguments[0] ? this.length - 1 : 0),
          this.view(t),
          this
        )
      },
      next: function () {
        ...
        return (
          this.view(
            (e = t < e ? (0 < arguments.length && void 0 !== arguments[0] && arguments[0] ? 0 : t) : e)
          ),
          this
        )
      },
      ...
      moveTo: function (t) {
        ...
        if (((t = Number(t)), (i = Number(i)), this.viewed && !this.played && s.movable)) {
          ...
          if ((J(t) ? (l = !0) : (t = r), J(i) ? (l = !0) : (i = h), l)) {
            if (
              (nt(s.move) && yt(o, 'move', s.move, { once: !0 }),
              !1 === xt(o, 'move', { x: t, y: i, oldX: r, oldY: h, originalEvent: n }))
            )
              return this
            ;(a.x = t),
              (a.y = i),
              ...
              this.renderImage(function () {
                ;(e.moving = !1),
                  nt(s.moved) && yt(o, 'moved', s.moved, { once: !0 }),
                  xt(o, 'moved', { x: t, y: i, oldX: r, oldY: h, originalEvent: n }, { cancelable: !1 })
              })
          }
        }
        return this
      ...
      rotateTo: function (t) {
        ...
        if (J((t = Number(t))) && this.viewed && !this.played && n.rotatable) {
          var s = o.rotate
          if (
            (nt(n.rotate) && yt(i, 'rotate', n.rotate, { once: !0 }),
            !1 === xt(i, 'rotate', { degree: t, oldDegree: s }))
          )
            return this
          ;(o.rotate = t),
            (this.rotating = !0),
            this.renderImage(function () {
              ;(e.rotating = !1),
                nt(n.rotated) && yt(i, U, n.rotated, { once: !0 }),
                xt(i, U, { degree: t, oldDegree: s }, { cancelable: !1 })
            })
        }
        return this
      },
      ...
      scale: function (t) {
        ...
        if (((t = Number(t)), (i = Number(i)), this.viewed && !this.played && o.scalable)) {
          ...
          if ((J(t) ? (h = !0) : (t = a), J(i) ? (h = !0) : (i = r), h)) {
            if (
              (nt(o.scale) && yt(n, 'scale', o.scale, { once: !0 }),
              !1 === xt(n, 'scale', { scaleX: t, scaleY: i, oldScaleX: a, oldScaleY: r }))
            )
              return this
            ;(s.scaleX = t),
              (s.scaleY = i),
              ...
              this.renderImage(function () {
                ;(e.scaling = !1),
                  nt(o.scaled) && yt(n, 'scaled', o.scaled, { once: !0 }),
                  xt(n, 'scaled', { scaleX: t, scaleY: i, oldScaleX: a, oldScaleY: r }, { cancelable: !1 })
              })
          }
        }
        return this
      ...
      zoom: function (t) {
        ...
        return (
          (t = Number(t)),
          this.zoomTo((n.width * (t = t < 0 ? 1 / (1 - t) : 1 + t)) / n.naturalWidth, e, i),
          this
        )
      },
      zoomTo: function (t) {
        ...
        if (J((t = Math.max(0, t))) && this.viewed && !this.played && (r || l.zoomable)) {
          ...
          var r = v * (t = a && 0.055 <= l.zoomRatio && 0.95 < t && t < 1.05 ? 1 : t),
            ...
            y = u.ratio
          if (
            (nt(l.zoom) && yt(h, 'zoom', l.zoom, { once: !0 }),
            !1 === xt(h, 'zoom', { ratio: t, oldRatio: y, originalEvent: a }))
          )
            return this
          ;(this.zooming = !0),
            a
            ...
            this.renderImage(function () {
              ;(e.zooming = !1),
                nt(l.zoomed) && yt(h, 'zoomed', l.zoomed, { once: !0 }),
                xt(h, 'zoomed', { ratio: t, oldRatio: y, originalEvent: a }, { cancelable: !1 })
            }),
            s && this.tooltip()
        }
        return this
      ...
      toggle: function () {
        ...
        return (
          1 === this.imageData.ratio ? this.zoomTo(this.imageData.oldRatio, !0, t) : this.zoomTo(1, !0, t),
          this
        )
      },
      reset: function () {
        return (
          this.viewed &&
            !this.played &&
            ((this.imageData = st({}, this.initialImageData)), this.renderImage()),
          this
        )
      },
      update: function () {
                  ...
                  (this.length
                    ? this.viewed &&
                      (0 <= (t = o.indexOf(this.index))
                        ? ((this.viewed = !1),
                          this.view(Math.max(Math.min(this.index - t, this.length - 1), 0)))
                        : (lt((t = this.items[this.index]), m), t.setAttribute('aria-selected', !0)))
                    : ((this.image = null),
                      (this.viewed = !1),
                      (this.index = 0),
                      (this.imageData = {}),
        ...
        return (
          t[g] &&
            ...
            this.ready
              ...
              : e.inline &&
                (this.delaying ? this.delaying.abort() : this.initializing && this.initializing.abort()),
    ...
    Ot = {
          ...
          yt(
            ...
            (this.onFocusin = function (t) {
              ...
              t === document ||
                t === e ||
                e.contains(t) ||
                (null !== t.getAttribute('tabindex') && 'true' === t.getAttribute('aria-modal')) ||
                e.focus()
            })
          )
      },
      ...
      shown: function () {
        ...
        ;(this.fulled = !0),
          ...
          nt(e.shown) && yt(t, B, e.shown, { once: !0 }),
          !1 !== xt(t, B) && this.ready && this.isShown && !this.hiding && this.view(this.index)
      },
      hidden: function () {
        var t = this.element,
          e = this.options,
        ...
        e.fucus && this.clearEnforceFocus(),
          ...
          (this.hiding = !1),
          this.destroyed ||
            (nt(e.hidden) && yt(t, 'hidden', e.hidden, { once: !0 }),
            xt(t, 'hidden', null, { cancelable: !1 }))
      },
        ...
        if (n) {
          ...
          switch (this.action) {
            ...
            case u:
              ...
              1 < h &&
                h > Math.abs(r) &&
                ((this.pointers = {}), 1 < o ? this.prev(e.loop) : o < -1 && this.next(e.loop))
          }
          ot(i, function (t) {
          ...
          },
          {
            ...
            value: function () {
              ...
              this.ready ||
                ...
                (n = (i = d.querySelector('.'.concat(g, '-container'))).querySelector(
                  '.'.concat(g, '-title')
                )),
                ...
                s.backdrop &&
                  (lt(i, ''.concat(g, '-backdrop')), s.inline || 'static' === s.backdrop || ft(d, K, 'hide')),
                _(s.className) &&
                  s.className &&
                    ...
                    ot(h ? s.toolbar : $, function (t, e) {
                      ...
                      !o ||
                        ...
                        -1 !== ['small', 'large'].indexOf(e)
                          ? lt(t, ''.concat(g, '-').concat(e))
                          : 'play' === n && lt(t, ''.concat(g, '-large')),
                        nt(i) && yt(t, O, i),
                        r.appendChild(t))
                    }),
                    o.appendChild(r))
                ...
                s.inline
                  ? (lt(m, b),
                    rt(i, { zIndex: s.zIndexInline }),
                    'static' === window.getComputedStyle(e).position && rt(e, { position: 'relative' }),
                    e.insertBefore(i, t.nextSibling))
                  : (lt(m, f),
                    lt(i, p),
                    lt(i, v),
                    lt(i, w),
                    rt(i, { zIndex: s.zIndex }),
                    (m =
                      (m = _((m = s.container)) ? t.ownerDocument.querySelector(m) : m) ||
